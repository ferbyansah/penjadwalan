...
class ReturController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Retur']))
		{
			...
			$getJumlah = Yii::app()->db->createCommand("SELECT * FROM barang_masuk where dipesan = '$model->jumlah'")->queryRow();
			// var_dump($getBarang['stok_akhir'] - $model->jumlah);die;
			if($model->jumlah <= $model->dipesan)
			{
				if($model->save())
			...
			else
			{
				// $b='bbbb';
				// var_dump($b);die;
				Yii::app()->user->setFlash('error', "Jumlah barang retur melebihi pembelian barang");
			}
	...
	{
		$dataProvider=new CActiveDataProvider('Retur');
