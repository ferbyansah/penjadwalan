...
class LaporanController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','delete','manage','admin','update'),
			...
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','manage','admin','create','search'),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Laporan']))
		{
			...
			$upstats = "UPDATE JADWAL SET STATUS = '$model->status' WHERE NO_PERJALANAN = '$model->no_perjalanan1'";
			$upstok = "UPDATE RUMAH_SAKIT SET STATUS = '$model->status' WHERE NAMA_RS = '$model->nama_rs'";
