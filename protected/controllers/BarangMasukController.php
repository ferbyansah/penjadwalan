...
class BarangMasukController extends Controller
{
	...
	public function actionGetValuesByNopo()
	{
	    $pincode = $_POST['BarangMasuk']['no_po'];
	    $data = PoSupplier::model()->find('nomor_po=:no_po', array(':no_po' => $pincode));
	    $output = array();
	    if (count($data) > 0)
	    {
	        $output['nama_barang'] = $data->nama_barang;
	        $output['dipesan'] = $data->jumlah;
	        $output['asal'] = $data->supplier;
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['BarangMasuk']))
		{
			...
			$upstats = "UPDATE PO_SUPPLIER SET STATUS = '$model->status' WHERE NOMOR_PO = '$model->no_po'";
