										...
										<div class="panel panel-default">
											<div class="panel-body">
												<div class="form-group">
													...
													<?php echo $form->textField($model,'biaya_pemesanan',array('size'=>60,'maxlength'=>200,'class'=>'form-control', 'value'=>'0%','placeholder'=>'Persentase dari harga barang, contoh 10%')); ?>
													<?php echo $form->error($model,'biaya_pemesanan'); ?>
												</div>
												<div class="form-group">
													<?php echo $form->labelEx($model,'biaya_penyimpanan'); ?>
													<?php echo $form->textField($model,'biaya_penyimpanan',array('size'=>60,'maxlength'=>200,'class'=>'form-control', 'value'=>'0%','placeholder'=>'Persentase dari harga barang, contoh 25%')); ?>
													<?php echo $form->error($model,'biaya_penyimpanan'); ?>
												</div>
												<div class="form-group">
													<?php echo $form->labelEx($model,'lead_time'); ?>
													<?php echo $form->numberField($model,'lead_time',array('size'=>60,'maxlength'=>200,'class'=>'form-control','id'=>'cek','placeholder'=>'Lead Time Hari')); ?>
