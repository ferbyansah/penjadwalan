										...
										<div class="panel panel-default">
											<div class="panel-body">
												<div class="form-group">
													...
													<?php echo $form->textField($model,'nomor_po',array('size'=>60,'maxlength'=>200,'class'=>'form-control','id'=>'cek','value'=>'PO-C')); ?>
													<?php echo $form->error($model,'nomor_po'); ?>
												</div>
												<div class="form-group">
													<?php echo $form->labelEx($model,'nama_barang'); ?>
													<?php if (empty($_GET['name'])) { 
													echo $form->dropDownList($model,'nama_barang', CHtml::listData(Barang::model()->findAll(),'nama_barang','nama_barang'),array('empty'=>'--Pilih--','class'=>'form-control'));
													}else{ ?>
														<input size="60" maxlength="200" class="form-control" id="cek" min="1" value="<?php echo $_GET['name'] ?>" name="PoCustomer[nama_barang]" type="text" readonly>
													<?php } ?>
												...
												<div class="form-group">
													...
													<?php echo $form->hiddenField($model,'status',array('size'=>60,'maxlength'=>200,'class'=>'form-control','id'=>'status','value'=>'Barang Belum Dikirimkan','readOnly'=>true)); ?>
