			...
			<div class="wrapper wrapper-content animated fadeInRight">
										...
										<div class="panel panel-default">
											<div class="panel-body">
												<div class="form-group">
													...
													echo $form->dropDownList($model,'no_po', CHtml::listData(PoCustomer::model()->findAll("status!='Barang Sudah Dikirimkan'"),'nomor_po','nomor_po'),array('empty'=>'--Pilih--','class'=>'form-control','id'=>'no_po'));
													}else{ ?>
														<input size="60" maxlength="200" class="form-control" id="no_po" value="<?php echo $_GET['name'] ?>" name="BarangKeluar[no_po]" type="text" readonly>
													<?php } ?>
												...
												<div class="form-group">
													...
													<?php echo $form->dropDownList($model,'tujuan',array('Bagian Penjualan'=>'Bagian Penjualan','Lainnya'=>'Lainnya'),array('empty'=>'--Pilih--','class'=>'form-control')); ?>
													<?php echo $form->error($model,'tujuan'); ?>
												</div>
												<div class="form-group">
													<?php echo $form->labelEx($model,'keterangan'); ?>
													<?php echo $form->textField($model,'keterangan',array('size'=>60,'maxlength'=>200,'class'=>'form-control','id'=>'cek')); ?>
													<?php echo $form->error($model,'keterangan'); ?>
												</div>
												<div class="form-group">
													<?php echo $form->labelEx($model,'status'); ?>
													<?php echo $form->dropDownList($model,'status',array('Barang Sudah Dikirimkan'=>'Barang Sudah Dikirimkan','Barang Belum Dikirimkan'=>'Barang Belum Dikirimkan'),array('empty'=>'--Pilih--','class'=>'form-control','id'=>'status')); ?>
				...
				<script>
					...
					$(document).ready(function(){
						...
						//make the ajax call
						$.ajax({
							url: "http://localhost/penjadwalan/protected/getpocustomer.php",
							type: 'POST',
							dataType : 'JSON',
							data: {nomor_po : no_po},
							success: function(response) {
								...
								$('#tanggal').val(response.BarangKeluar_tanggal);
							}
						});
					});
					});
