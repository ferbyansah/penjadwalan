										...
										<div class="panel panel-default">
											<div class="panel-body">
												...
												<div class="form-group">
													...
													<?php echo $form->textField($model,'kode_barang',array('size'=>60,'maxlength'=>200,'class'=>'form-control','value' => (($model->isNewRecord)?$model->generateKode_Barang():$model->$no),'readonly'=>true,'id'=>'cek')); ?>
												...
												<div class="form-group">
													<?php echo $form->errorSummary($model); ?>
													<?php echo $form->labelEx($model,'kode_barang'); ?>
													<?php echo $form->textField($model,'kode_barang',array('size'=>60,'maxlength'=>200,'class'=>'form-control','value' => (($model->isNewRecord)?$model->generateKode_Barang():$model->kode_barang),'readonly'=>true,'id'=>'cek')); ?>
													<?php echo $form->error($model,'kode_barang'); ?>
												</div>
												<?php } ?>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<?php echo $form->numberField($model,'harga',array('size'=>60,'maxlength'=>200,'class'=>'form-control','id'=>'cek')); ?>
													<?php echo $form->error($model,'harga'); ?>
												</div>
												<div class="form-group">
													<?php echo $form->labelEx($model,'penggunaan_tahun'); ?>
													<?php echo $form->numberField($model,'penggunaan_tahun',array('size'=>60,'maxlength'=>200,'class'=>'form-control','id'=>'cek')); ?>
													<?php echo $form->error($model,'penggunaan_tahun'); ?>
												</div>
												<div class="form-group">
													<?php echo $form->labelEx($model,'safety_stok'); ?>
													<?php echo $form->numberField($model,'safety_stok',array('size'=>60,'maxlength'=>200,'class'=>'form-control','id'=>'cek')); ?>
												...
												<div class="form-group">
													...
													echo $form->dropDownList($model,'supplier', CHtml::listData(Supplier::model()->findAll(),'nama_perusahaan','nama_perusahaan'),array('empty'=>'--Pilih--','class'=>'form-control'));
													}else{ ?>
														<input size="60" maxlength="200" class="form-control" id="cek" min="1" value="<?php echo $_GET['supplier'] ?>" name="Barang[supplier]" type="text" readonly>
													<?php } ?>
