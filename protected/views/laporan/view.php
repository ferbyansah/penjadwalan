...
<center><h3><img width="100px" height="60px" src="images/jh.jpeg">  PT.Jalan Hijau</br>
	...
	<h3>Laporan Pengambilan Limbah Bahan Berbahaya dan Beracun</h3>
</center>
<br>
<br>
	<table class="table">
...
<p>Laporan Hasil Pengambilan Limbah ke <b><?php echo $model->nama_rs; ?></b> dengan data sebagai berikut :</p>
<br>
...
<table class="row">
  ...
  <td width="200px">Pelaksana</td>
      ...
      <div style="text-align: right;">
        <p>Di Keluarkan Di : Jakarta, Pada <?php echo date('d/m/Y') ?></p>
      </div>
      <div class="container">
        <table  width="1100px">
        <tr>
        <th width="1500px">Administration</th>
        <!-- <th width="500px">Administration</th> -->
      ...
      <div class="container">
        <table  width="1100px">
        <tr>
          <th width="1535px">Pemberi Laporan</th>
