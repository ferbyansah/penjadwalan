...
class Jadwal extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('no_perjalanan, nama_rs, alamat, jarak, estimasi_beban, no_plat, nama_supir, urutan_tujuan, status, tanggal', 'required'),
			// array('jumlah', 'numerical', 'integerOnly'=>true),
			array('nama_rs,status', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('no_perjalanan, nama_rs, alamat, estimasi_beban, no_plat, nama_supir, urutan_tujuan, status, tanggal', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'no_perjalanan' => 'Nomor Perjalanan',
			'nama_rs' => 'Nama Rumah Sakit',
			'alamat' => 'Alamat',
			'jarak' => 'Jarak Tempuh Rumah Sakit',
			'estimasi_beban' => '(Estimasi) Beban Angkut Limbah [KG]',
			'no_plat' => 'Plat Kendaraan',
			'nama_supir' => 'Nama Supir',
			'urutan_tujuan' => 'Urutan Tujuan Perjalanan Truk',
