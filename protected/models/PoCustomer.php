 ...
 */
class PoCustomer extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('nomor_po, nama_barang, jumlah, status, tanggal', 'required'),
			array('jumlah', 'numerical', 'integerOnly'=>true),
			array('nama_barang,status', 'length', 'max'=>40),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, nomor_po, nama_barang, jumlah, status, tanggal', 'safe', 'on'=>'search'),
		);
	}
